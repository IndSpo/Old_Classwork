...
select guest_no from BOOKINGS where guest_no not in (select guest_no from GUESTS); 
    
Alter TABLE GUESTS
    ADD CONSTRAINT FK_GuestRooms
    Foreign Key (room_no) REFERENCES ROOMS(room_no); 

Alter TABLE BOOKINGS
    ADD CONSTRAINT FK_HotelBookings
...
Insert into BOOKINGS values (DATE '2017-03-25', DATE '2017-03-31', 231, 2);
Insert into BOOKINGS values (DATE '2017-04-01', DATE '2017-04-22', 013, 5);
Insert into BOOKINGS values (DATE '2017-12-19', DATE '2018-01-01', 109, 4);
Insert into BOOKINGS values (DATE '2017-05-13', DATE '2017-05-17', 626, 1);
Insert into BOOKINGS values (DATE '2017-11-06', DATE '2017-11-28', 004, 5);
Insert into BOOKINGS values (DATE '2018-07-01', DATE '2018-07-31', 325, 6);
Insert into BOOKINGS values (DATE '2018-08-06', DATE '2018-08-20', 745, 2);
